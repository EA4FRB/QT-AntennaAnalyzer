...
md ..\..\installer\win32
copy ..\..\build-analyzer-Desktop_Qt_5_10_1_MinGW_32bit-Release\release\analyzer.exe packages\com.vendor.product\data\analyzer.exe
C:\Qt\5.10.1\mingw53_32\bin\windeployqt packages\com.vendor.product\data\analyzer.exe
